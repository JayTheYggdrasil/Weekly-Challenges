...
class Sphere(Area):
    ...
    def random_point_inside(self, rng: SeededRandomNumberGenerator) -> Vector3:
        ...
        offset: Vector3 = Vector3(self.radius * math.sin(theta) * math.cos(phi), self.radius * math.sin(theta) * math.sin(phi), self.radius * math.cos(theta))
...
class VerticalCyl(Area):
    ...
    def random_point_inside(self, rng: SeededRandomNumberGenerator) -> Vector3:
        offset: Vector3 = Vector3(math.cos(rng.rself.radiusndom() * math.pi * 2) * self.radius, math.sin(rng.random() * math.pi * 2) * self.radius, rng.n11() * height)
        return add(self.center, offset)
